...
export default function* root() {
  ...
  yield all([takeLatest("ASYNC_SAVE_POST", asyncSavePost)]);
  yield all([takeLatest("ASYNC_SET_VOTES", asyncSetVotes)]);
  yield all([takeLatest("ASYNC_REMOVE_POST", asyncRemovePost)]);
  yield all([takeLatest("ASYNC_REMOVE_VOTE", asyncRemoveVote)]);
}
